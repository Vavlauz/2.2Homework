...
//    }
    ...
    fun testChangeTextToEmptyField() {
        ...
        val startResult = device.findObject(By.res(packageName, "textToBeChanged")).text
        device.findObject(By.res(packageName, "userInput")).text = "      "
        device.findObject(By.res(packageName, "buttonChange")).click()

        val result = device.findObject(By.res(packageName, "textToBeChanged")).text
        assertEquals(result, startResult)
    }
    ...
    fun testChangeTextAndNewActivity() {
        ...
        device.findObject(By.res(packageName, "userInput")).text = "asad"
        device.findObject(By.res(packageName, "buttonActivity")).click()
        waitForPackage(packageName)

        var result = device.findObject(By.res(packageName, "text")).text
        assertEquals(result, "asad")
